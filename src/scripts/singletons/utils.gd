...
func _process(_delta):
	if Utils.is_mobile_platform() and current_screen_orientation != DisplayServer.screen_get_orientation():
...
func _on_screen_orientation_changed() -> void:
	...
	print("ORIENTATION CHANGED to: ", DisplayServer.screen_get_orientation(), ", orientation_extents: ", orientation_extents, ", w_size: ", w_size, ", margin_l: ", margin_l, ", margin_t: ", margin_t, ", margin_r: ", margin_r, ", margin_b: ", margin_b)
